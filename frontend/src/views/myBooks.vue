<template>
  <div class="pb-16">
    ...
    <div v-else-if="books.length === 0" class="text-center pa-8 text-medium-emphasis">
      ...
      <div class="text-h6">Ainda não tens livros</div>
      <div class="text-body-2 mb-4">Adiciona o teu primeiro livro à biblioteca</div>
      ...
      <v-card rounded="xl" class="pa-4">
        ...
        <v-form @submit.prevent="addNewBook" ref="addFormRef">
          ...
          <v-card-actions class="pt-2 px-0">
            ...
            <v-btn color="primary" type="submit" :loading="adding">Guardar</v-btn>
          </v-card-actions>
        </v-form>
      </v-card>
    </v-dialog>
